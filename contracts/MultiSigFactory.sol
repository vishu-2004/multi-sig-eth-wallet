...
contract MultiSigFactory {
    ...
    event WalletCreated(address indexed creator, address walletAddress, uint256 threshold, uint256 timeLock);


    function createWallet(address[] memory owners, uint256 threshold, uint256 timeLock) public {
